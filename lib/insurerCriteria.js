...
const INSURER_CRITERIA = {
  ...
  // Additional insurers follow UHC patterns with variations
  "Cigna": null, // Falls back to UHC criteria with note
  "Humana": null,
...
function getInsurerCriteria(insurer, drugClass) {
  ...
  if (!criteria || criteria === null) {
    // Fallback to UHC criteria for insurers without specific data
    criteria = INSURER_CRITERIA["UnitedHealthcare"];
  }
