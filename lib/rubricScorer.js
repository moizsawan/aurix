...
const RUBRIC_CRITERIA = [
  ...
  },
  {
    ...
    weight: 2,
    description: "HCPCS codes, authorization duration, place of service, monitoring plan",
    checks: [
...
function generateCriterionInstruction(criterionId, failedChecks) {
  const instructions = {
    ...
    administrative_completeness: "Include the HCPCS billing code for the requested treatment. Specify the requested authorization duration. State the place of service. Include a monitoring and follow-up schedule.",
